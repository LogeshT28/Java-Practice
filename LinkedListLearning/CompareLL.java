...
public class CompareLL {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            System.out.println(
                    "Enter 1 to insert data into list1, 2 to insert data into list2, 3 to display list1, 4 to display list2, 5 to compare the lists, 6 to Remove First Element ,7 to exit:");
